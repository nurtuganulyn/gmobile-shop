    ...
    return (
      <div>
        <div style={{ padding: 10, display: "flex", alignItems: "center" }}>
          ...
          >
            <MenuItem value={"lh"}>Сортировать по цене: по возрастанию</MenuItem>
            <MenuItem value={"hl"}>Сортировать по цене: по убыванию</MenuItem>
          </Select>
        </div>
